...
import React from 'react'; // Import React to declare JSX.Element
...
// Large, kid-friendly chess piece SVGs
export function ChessPiece({ type, color, size = 48 }: ChessPieceProps) {
  const fillColor = color === 'white' ? 'var(--piece-white)' : 'var(--piece-black)'
  const strokeColor = color === 'white' ? 'var(--piece-black)' : 'var(--piece-white)'
  
  const pieces: Record<PieceType, React.JSX.Element> = { // Use React.JSX.Element instead of JSX.Element
    king: (
    ...
    queen: (
      <svg viewBox="0 0 45 45" width={size} height={size}>
        <g fill={fillColor} stroke={strokeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M11 29a35 35 1 0 1 23 0m-21.5 2.5h20m-21 3a35 35 1 0 0 22 0m-23 3a35 35 1 0 0 24 0" fill="none" stroke={strokeColor}/>
        </g>
      </svg>
    ),
    rook: (
    ...
    bishop: (
      <svg viewBox="0 0 45 45" width={size} height={size}>
        <g fill="none" fillRule="evenodd" stroke={strokeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" stroke={strokeColor} strokeLinejoin="miter"/>
        </g>
      </svg>
    ),
    knight: (
      <svg viewBox="0 0 45 45" width={size} height={size}>
        <g fill="none" fillRule="evenodd" stroke={strokeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zm5.433-9.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill={strokeColor} stroke={strokeColor}/>
        </g>
      </svg>
    ),
    pawn: (
      <svg viewBox="0 0 45 45" width={size} height={size}>
        <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill={fillColor} stroke={strokeColor} strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    )
  }
